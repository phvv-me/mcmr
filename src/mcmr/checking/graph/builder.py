...
from ...domain.contracts import FactDataset, RuleJob, RunGraph
...
class RunGraphBuilder:
    ...
    def record(
        ...
        for rule in rules:
            ...
            self.jobs[definition.id] = self._job(rule, definition)
    ...
    def _job(self, rule: PreparedRule, definition: RuleDefinition) -> RuleJob:
